const ToolManager = (() => {
  ...
  tools["eyedropper"] = new EyeDropperTool(
    "eyedropper",
    { type: "cursor", style: "crosshair" },
    switchTool,
  );
  ...
  tools["moveselection"] = new MoveSelectionTool(
    "moveselection",
    { type: "cursor", style: "crosshair" },
    switchTool,
    tools["brush"],
  );
  tools["rectselect"] = new RectangularSelectionTool(
    "rectselect",
    { type: "cursor", style: "crosshair" },
    switchTool,
    tools["moveselection"],
  );
  tools["lassoselect"] = new LassoSelectionTool(
    "lassoselect",
    { type: "cursor", style: "crosshair" },
    switchTool,
    tools["moveselection"],
  );
  tools["magicwand"] = new MagicWandTool(
    "magicwand",
    { type: "cursor", style: "crosshair" },
    switchTool,
    tools["moveselection"],
      ...
      switch (mouseEvent.which) {
        case 1:
          if (Input.isSpacePressed()) {
            ...
            !currFile.currentLayer.isLocked ||
            !(Object.getPrototypeOf(currTool) instanceof DrawingTool)
          ) {
