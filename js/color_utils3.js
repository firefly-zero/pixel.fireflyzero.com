...
const example = {
  red: ["#bf6f4a", "#e07438", "#c64524", "#ff5000"],
  green: ["#99e65f", "#5ac54f", "#33984b"],
  blue: ["#0069aa", "#0098dc", "#00cdf9"],
  cyan: ["#0069aa", "#0098dc", "#00cdf9", "#0cf1ff"],
  yellow: ["#ffa214", "#ffc825", "#ffeb57"],
  magenta: ["#db3ffd"],
  light: ["#ffffff", "#f9e6cf", "#fdd2ed"],
  dark: ["#131313", "#1b1b1b", "#272727", "#3d3d3d", "#5d5d5d"],
  brown: [
    "#e69c69",
    "#f6ca9f",
    "#f9e6cf",
...
function similarColors(rgb1, rgb2) {
  ...
  //////console.log(ret);
  return (
    (ret < distanceThreshold && lightColoursCheck(rgb1, rgb2)) ||
    darkColoursCheck(rgb1, rgb2)
  );
}
function lightColoursCheck(rgb1, rgb2) {
  ...
  if (
    rgb1.r > lightColoursThreshold &&
    rgb1.g > lightColoursThreshold &&
    rgb1.b > lightColoursThreshold &&
    rgb2.r > lightColoursThreshold &&
    rgb2.g > lightColoursThreshold &&
    rgb2.b > lightColoursThreshold
  ) {
    return (
      rDelta < lightColoursSimilarityThreshold &&
      gDelta < lightColoursSimilarityThreshold &&
...
function darkColoursCheck(rgb1, rgb2) {
  ...
  // Checking only if the colours are dark enough
  if (
    rgb1.r < darkColoursThreshold &&
    rgb1.g < darkColoursThreshold &&
    rgb1.b < darkColoursThreshold &&
    rgb2.r < darkColoursThreshold &&
    rgb2.g < darkColoursThreshold &&
    rgb2.b < darkColoursThreshold
  ) {
    return (
      rDelta < darkColoursSimilarityThreshold &&
      gDelta < darkColoursSimilarityThreshold &&
