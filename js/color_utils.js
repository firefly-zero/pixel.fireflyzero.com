...
function lightColoursCheck(c1, c2) {
  ...
  if (
    c1.r > lightColoursThreshold &&
    c1.g > lightColoursThreshold &&
    c1.b > lightColoursThreshold &&
    c2.r > lightColoursThreshold &&
    c2.g > lightColoursThreshold &&
    c2.b > lightColoursThreshold
  ) {
    return (
...
function darkColoursCheck(c1, c2) {
  ...
  // Checking only if the colours are dark enough
  if (
    c1.r < darkColoursThreshold &&
    c1.g < darkColoursThreshold &&
    c1.b < darkColoursThreshold &&
    c2.r < darkColoursThreshold &&
    c2.g < darkColoursThreshold &&
    c2.b < darkColoursThreshold
  ) {
    return (
...
function RGBtoCIELAB(rgbColour) {
  ...
  let x =
    0.412453 * rgbColour.r + 0.35758 * rgbColour.g + 0.180423 * rgbColour.b;
  let y =
    0.212671 * rgbColour.r + 0.71516 * rgbColour.g + 0.072169 * rgbColour.b;
  let z =
    0.019334 * rgbColour.r + 0.119193 * rgbColour.g + 0.950227 * rgbColour.b;
