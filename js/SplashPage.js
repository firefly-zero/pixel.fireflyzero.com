const SplashPage = (() => {
  const images = [
    new SplashCoverImage(
      "Rayquaza",
      "Unsettled",
      "https://lospec.com/unsettled",
    ),
    new SplashCoverImage(
      "Mountains",
      "Skeddles",
      "https://lospec.com/skeddles",
    ),
    new SplashCoverImage("Sweetie", "GrafxKid", "https://twitter.com/GrafxKid"),
    new SplashCoverImage(
      "Glacier",
      "WindfallApples",
      "https://lospec.com/windfallapples",
    ),
    new SplashCoverImage(
      "Polyphorge1",
      "Polyphorge",
      "https://lospec.com/poly-phorge",
    ),
    new SplashCoverImage(
      "Fusionnist",
      "Fusionnist",
      "https://lospec.com/fusionnist",
    ),
  ];
