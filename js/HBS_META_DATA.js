const HBS_META_DATA = {
  ...
  "./views/foobar.hbs": {
    ...
    dblCurlsArr: ["title", "> canvases", "#reload", "/reload"],
    partialArr: ["canvases"],
  },
  "./views/index.hbs": {
    fileStr:
  ...
  "./views/popups/about.hbs": {
    ...
    dblCurlsArr: ['svg "x.svg" width="20" height="20"'],
    partialArr: [],
  },
