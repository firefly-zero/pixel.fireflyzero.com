  ...
  window.jscolor = (function () {
    var jsc = {
        ...
        if (target._jscLinkedInstance) {
          ...
          if (jsc.picker && jsc.picker.owner) {
            ...
            if (e.target.className == "delete-color-button") {
              ...
              e.target.parentElement.classList.contains("jscolor-picker-bottom")
            ) {
              ...
              var hiddenButton = document.querySelector(
      ...
      jscolor: function (targetElement, options) {
        ...
        this.show = function () {
          ...
          if (colors.length == 1) deleteButton.classList.add("disabled");
          else deleteButton.classList.remove("disabled");

          //hide duplicate color warning
          let duplicateColorWarning = document.getElementById(
            "duplicate-color-warning",
          );
    ...
    */
          ...
          if (colorPickerBottomAdded != true) {
            ...
            var jsColorPickerBottom = document.getElementsByClassName(
